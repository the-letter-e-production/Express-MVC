...
/**
 * Exceptions Utility - Static Class
 *
 * @class
 */
var Exception_Util = {
    /**
     * Middleware template store
     *
    ...
    /**
     * Set new middleware template
     *
     * @param {function} template - Override for middleware_template
     * @example
     * ExpressMVC.Util.exception.set_middleware_template(function(exception, message){ return 'My Template'; });
     */
     ...
     *
     * @example
     * var template = Exception_Util.get_middleware_template();
     */
     ...
     * @param {Express_Request} req - Express request
     * @param {Express_Response} res - Express response
     * @param {function} [next] - Next middleware handler
     * @example
     * app.use(ExpressMVC.Util.exception.middleware);
     */ 
     ...
     * @return {Error}
     * @example
     * throw ExpressMVC.Util.exception.factory('default', 'My error!', 500, 'public', true);
     */
